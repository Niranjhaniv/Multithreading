...
public class AuctionServer {
	...
	// that have expired).
	private ArrayListWrapper<Item> itemsUpForBidding = new ArrayListWrapper<Item>();
	...
	private HashMapWrapper<Integer, AtomicReference<Item>> itemsAndIDs = new HashMapWrapper<Integer, AtomicReference<Item>>();

	// List of itemIDs and the highest bid for each item. This is a running list
	// with everything ever added to the auction.
	private HashMapWrapper<Integer, Integer> highestBids = new HashMapWrapper<Integer, Integer>();
	...
	private HashMapWrapper<Integer, String> highestBidders = new HashMapWrapper<Integer, String>();

	// List of sellers and how many items they have currently up for bidding.
	private HashMapWrapper<String, Integer> itemsPerSeller = new HashMapWrapper<String, Integer>();

	// List of buyers and how many items on which they are currently bidding.
	private HashMapWrapper<String, Integer> itemsPerBuyer = new HashMapWrapper<String, Integer>();

	private HashMapWrapper<String, Integer> sellerBlacklistMap = new HashMapWrapper<String, Integer>();

	private ArrayListWrapper<String> blacklistedSeller = new ArrayListWrapper<String>();

	private HashMapWrapper<String, Integer> sellerItemExpirationMap = new HashMapWrapper<String, Integer>();

	private ArrayListWrapper<String> blacklistedBidder = new ArrayListWrapper<String>();
