...
public class Validate {
	...
	public static boolean validateSimulation(List<SimulationEvent> events,
		...
		foundError = check(checkRestaurantCapacity(events, numTables),
		...
		foundError = check(customerLeavesTest(events, numCustomers),
	...
	private static boolean customerLeavesTest(List<SimulationEvent> events,
			int numCustomers) {
	...
	private static boolean checkRestaurantCapacity(
