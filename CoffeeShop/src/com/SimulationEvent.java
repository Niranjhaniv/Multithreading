...
public class SimulationEvent {
	...
	case CustomerStarting:
	    return customer + " going to coffee shop. " + customer.getPriority() + " Customer";

	case CustomerEnteredCoffeeShop:
	    return customer + " entered coffee shop." +  customer.getPriority() + " Customer";

	case CustomerPlacedOrder:
	    return customer + " placing order " + orderNumber + " " + orderFood; 
	    
	case CustomerReceivedOrder:
	    return customer +" ( " + customer.getPriority()  +" Customer )" +" received order " + orderNumber + " " + orderFood;

	case CustomerLeavingCoffeeShop:
	    return customer +"( "+ customer.getPriority() +" Customer )"+ " leaving coffee shop." ;
